...
const EXPERIENCE = [
  {
    ...
    company: "Kapture CX",
    org: "Adjetter Media Network",
    location: "Bengaluru",
    dates: "Jun 2025 to Present",
    current: true,
    summary: "Owning roadmaps for GenAI Knowledge Base and Auto-QA. Driving 30% enterprise adoption, 90% chat deflection at a major financial services client, and 40% faster support resolution across B2C rollouts.",
    chips: ["GenAI", "RAG", "LLM evaluation", "Auto-QA", "Chatbot orchestration"],
  },
  {
    role: "Associate Product Manager",
    company: "LeadSquared",
    org: "MarketXpander Services",
    location: "Bengaluru",
    dates: "May 2024 to Jun 2025",
    summary: "Owned 3+ Service Cloud modules in a 6-PM pod. Shipped 3 AI features 0→1 (Recommend-a-Reply, Smart Reply, Tone Selection) cutting agent effort by 30%. Onboarded 20+ enterprise clients, contributing ₹20L MRR.",
    chips: ["Service Cloud", "0→1 AI features", "Workflow discovery", "Enterprise onboarding"],
  },
  {
    role: "Team Lead",
    company: "BYJU'S",
    org: "Think & Learn",
    location: "Bengaluru",
    dates: "Jun 2019 to Jun 2022",
    summary: "Managed 50+ members; analyzed 500+ student insights to influence feature and content roadmap. Led a 5-person squad to ship 60+ learning modules. Sustained 9/10 NPS, ranked 5/75 leaders, top 5% promotion.",
    chips: ["People leadership", "Insight analysis", "Content shipping", "NPS"],
  },
];
...
function CaseStudy({ c, expanded, onToggle }) {
  return (
    <article className={`case ${expanded ? "is-open" : ""}`} id={c.id}>
      ...
      {(() => {
        const num = c.tag.match(/\d+/)?.[0] || "";
        const label = c.tag.replace(/^\d+\s*·\s*/, "");
        return (
    ...
    <>
      ...
      <main className="page" id="top">
          ...
          <div className="about-grid">
            ...
            <aside className="about-side">
              ...
              <div className="about-side-row">
                <span className="ico">📍</span>
                <div>
                  <div className="ico-label">Based in Bangalore</div>
                  <div className="ico-sub">India</div>
                </div>
              </div>
              <div className="about-side-row">
                <span className="ico">✉️</span>
                <div>
                  <div className="ico-label"><a href="mailto:syed.maaz.u@gmail.com" style={{borderBottom:"1px solid var(--line)"}}>syed.maaz.u@gmail.com</a></div>
                </div>
              </div>
              <div className="about-side-row">
                <span className="ico">🟢</span>
                <div>
                  <div className="ico-label">Available for full-time</div>
                  <div className="ico-sub">Open to AI PM roles</div>
                </div>
              </div>
              <div className="about-side-row">
                <span className="ico">🎓</span>
        ...
        <section className="section" id="experience">
          ...
          <h2 className="section-h">Where I've worked</h2>
          <div className="exp">
            {EXPERIENCE.map((e) => (
              <div className="exp-card" key={e.company}>
                <div className="exp-card-top">
                  <div className="exp-card-co">
                    <div className="exp-co-name">{e.company} <span className="exp-co-org">· {e.org}</span></div>
                    <div className="exp-co-role">{e.role}  ·  {e.location}</div>
                  </div>
                ...
                <div className="exp-chips">
                  {e.chips.map((c) => <span className="chip exp-chip" key={c}>{c}</span>)}
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="section" id="work">
          ...
          <h2 className="section-h">Products I've built</h2>
          <div className="cases">
            {CASES.map((c) => (
